...
export default function EditMovie({movie}) {
    ...
    const updateMovie = async(form) => {
        ...
        const response = await fetch(`http://localhost:5001/api/v1/movie/${movie.id}`, requestOptions)
    ...
    return (
        <Layout>
                ...
                <div className="md:container md:mx-auto">
                    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" encType="multipart/form-data" onSubmit={handleSubmit(updateMovie)}>
                        <div className="mb-4">
                            ...
                            <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" 
                                {...register('name', { value: `${movie.name}` }, {required: true})} />
                        ...
                        <div className="mb-3">
                                ...
                                <div className='w-full md:w-5/6 mb-6 md:mb-0'>
                                                    ...
                                                    className="mr-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    type="text"
                                                    {...register("director", {value: `${movie.directors[0]}`})}
                                                    />
                                </div>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            type="text" id="imdb" name="imdb" {...register('IMDB', {value: `${movie.IMDB}`} ,{pattern:/^([1-9]|10)\.[0-9][0-9]|[1-7]$ /} )}/>
                        ...
                        <div className="flex flex-wrap -mx-3 mb-2">
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" id="youtube" name="youtube" {...register('youtube', {value: `${movie.youtube}`}, {pattern:/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/})}/>
                            ...
                            <div className="w-full md:w-1/2 px-3">
                                ...
                                <input className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                type="text" id="duration" name="duration" {...register('duration',{value: `${movie.duration}`} ,{required: true, pattern: /\d+/ })} />
                                { errors.duration && 
                                   <div>
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex flex-wrap relative">
                                ...
                                {...register('startDate', {value: `${moment(movie.startDate).format('YYYY-MM-DD')}`} ,{required: true})}/>
                        ...
                        <div className="mb-4">  
                            ...
                            {...register('synopsis', {value: `${movie.synopsis}` })}></textarea>
                        </div>
...
export async function getStaticProps(context) {
    ...
    const res = await fetch(`http://localhost:5001/api/v1/movie/${params.id}`)
